                                            ...
                                            <td style="padding: 20px 20px; font-family: Arial, Helvetica; color: #666666; font-size: 12px;" colspan="2">
                                                <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td style="background-color: green; color:white; height: 30px; font-size: x-large;">
                                                                <strong> 
                                                                    <center>
                                                                    <?php
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="color: #666666; font-size: 12px;" align="left">
                                                                <strong>
                                                                    <?php
                                                                    echo "Kedves $from_name! <br> <br>";
                                                                    echo "Szeretettel köszöntünk az ".CHtml::link('www.ourtruetreasure.com','www.ourtruetreasure.com')." felhasználói körében!";
                                                                    ?>
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="color: #666666; font-size: 12px;" align="left"> 
                                                                ...
                                                                <?php echo "Biztonsági okokból nem küldjük ki e-mailben. Amennyiben elfelejtetted jelszavad, kattints a honlapon található elfelejtett jelszó menüpontra." ?>
                                                            </td>  
                                                        </tr>
                                                        <tr>
                                                            <td> 
                                                        ...
                                                        <tr>
                                                            <td colspan="2" style="color: #666666; font-size: 11px;"><!-- <p>Here is your invoice for ##current_invoice_date##. You can pay your invoice by logging in to your LocalSnag Account Click <a href="login">here</a> to log in.</p> -->
